...
urlpatterns = [
    ...
    path('group/<str:group>/add_manager/<str:username>', views.group_manager_add, name="group_manager_add"),
    path('group/<str:group>/remove_manager/<str:username>', views.group_manager_remove, name="group_manager_remove"),
